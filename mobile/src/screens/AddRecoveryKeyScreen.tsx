    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            style={[styles.methodRow, method === 'crypto_wallet' && styles.methodRowActive]}
            onPress={() => { setMethod('crypto_wallet'); logAddRecoveryKeyPress(); }}
            disabled={submitting}
          >
            <View style={styles.radioOuter}>
              {method === 'crypto_wallet' && <View style={styles.radioInner} />}
            </View>
            <View style={styles.methodInfo}>
              <Text style={styles.methodLabel}>Crypto Wallet</Text>
              <Text style={styles.methodDescription}>Add a Solana wallet address as recovery key</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.methodRow, method === 'email' && styles.methodRowActive]}
          ...
          >
            ...
            <View style={styles.methodInfo}>
              ...
              <Text style={styles.methodDescription}>Restore access via email with a Privy embedded wallet</Text>
            </View>
          </TouchableOpacity>
        </View>
          ...
          <>
            ...
            >
              {submitting ? (
                ...
                <Text style={styles.submitButtonText}>Add Recovery Key</Text>
              )}
            </TouchableOpacity>
          </>
        )}
